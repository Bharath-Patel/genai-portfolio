...
#chunk overlap is to have a buffer btwn the chunks so that there is no awkward split btwn the sentences,so information near boundaries doesn't get isolated awkwardly in just one chunk.
